...
Second we show that  $F_{X'''}(s_i) \leq F_{X''}(s_i)$. Since $X \preceq_{\varepsilon^*,m} X''$, $F_X(s_i) + Pr(s_i < X < s_{i+1}) \leq  Pr(X''<s_{i+1})$. As $s_1,\dots,s_m$ is the support of $X''$, $Pr(X''<s_{i+1}) = F_{X''}(s_i)$. By definition $F_{X'''}(s_i) = F_X(s_i) + Pr(s_i < X < s_{i+1})$. Together we get that $F_{X'''}(s_i) \leq F_{X''}(s_i)$.
